...
public interface ISavedViewOrchestrator
{
    ...
    Task<SavedView?> GetDefaultAsync(string pageKey, string? ownerKey, CancellationToken cancellationToken = default);
    ...
    Task<SavedView?> SetDefaultAsync(int id, bool isDefault, CancellationToken cancellationToken = default);

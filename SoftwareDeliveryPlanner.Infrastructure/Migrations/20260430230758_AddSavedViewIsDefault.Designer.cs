...
namespace SoftwareDeliveryPlanner.Infrastructure.Migrations
{
    ...
    [Migration("20260430230758_AddSavedViewIsDefault")]
    partial class AddSavedViewIsDefault
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SoftwareDeliveryPlanner.Domain.Models.PlanScenario", b =>
                {
                    ...
                    b.Property<string>("GanttZoomLevel")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
            ...
            modelBuilder.Entity("SoftwareDeliveryPlanner.Domain.Models.SavedView", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("OwnerKey", "PageKey");

                    b.HasIndex("OwnerKey", "PageKey", "IsDefault")
                        .IsUnique()
                        .HasFilter("[IsDefault] = 1");

                    b.HasIndex("OwnerKey", "PageKey", "Name")
                        .IsUnique();

                    b.ToTable("SavedViews", "filter");
                });
